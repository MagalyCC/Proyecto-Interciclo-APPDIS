...
@Stateless
public class CorreoON implements CorreoONRemoto{
	private static final String senderEmail = "aplicacionesd2020@gmail.com";//change with your sender email
	  private static final String senderPassword = "apli2020";//change with your sender password
	  /**
