...
/**
 * 
 * Anotacion @Entity esta anotación se debe de definir a nivel de clase y sirve
 * únicamente para indicarle a JPA
 */
@Entity
public class Cuenta implements Serializable {
	 ...
	 * Anotación@GeneratedValue con JPA es algo bastante habitual ya que existen
	...
	/**
	 * Anotación @Temporal es posible mapear las fechas con la base de datos de una
	 * forma simple
	 */
	...
	/**
	 * @OneToMany por Entidad donde tenemos un objeto principal y colección de
